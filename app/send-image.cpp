...
int main(int argc, char **argv){
  ...
  std::string description = "This application reads a single image from a file and publishes it via rsb.";
  ...
  desc.add_options()
      ...
      ("type,t",
       ...
       "The output type to use. Can be on of ( img | bmp | ppm | png | jpg | jp2 | tiff ). "
       "The send image data is rst::vision::Image in case of 'img' and rst::vision::EncodedImage "
       "in all other cases.")
